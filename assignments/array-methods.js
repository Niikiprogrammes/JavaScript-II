...
let allCaps = [];
runners.forEach(r => allCaps.push(r.first_name.toLocaleUpperCase()));
console.log(allCaps); 
console.log('');
...
let ticketPriceTotal = runners.reduce(total,r) => total += r.donation, 0);
console.log(ticketPriceTotal.toLocalString("en-US", {style: "currency", currency: "USD", minimumFractionDigits: 2}));
